...
> For propositions are not made true by the evidence that exists for them, but by their conformity to the state of affairs in the world, as is evident from the fact that one can have massive amounts of evidence for a false proposition and lack of any evidence for a true one. 
