...
* Idenitifcation is about understanding if there is enough information in the observed data, with an infinite sample size, to draw conclusions about the unobserved population model (statistical parameters).
...
## View our CFA Data {.scrollable = TRUE}
